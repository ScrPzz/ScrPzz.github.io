...
- **Global scope**: `/home/atogni/Desktop/progetti/atogni.github.io/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/atogni/Desktop/progetti/atogni.github.io/.claude/notes/`)
...
2. Glob `/home/atogni/Desktop/progetti/atogni.github.io/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/atogni/Desktop/progetti/atogni.github.io/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/atogni/Desktop/progetti/atogni.github.io/.claude/notes/` — works in any directory
