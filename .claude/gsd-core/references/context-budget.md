...
The keys live in `.claude/settings.json` (project) or `/home/atogni/Desktop/progetti/atogni.github.io/.claude/settings.json` (global) — **not** in `.planning/config.json`:
