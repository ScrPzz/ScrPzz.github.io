...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/atogni/Desktop/progetti/atogni.github.io/.claude/.gsd-surface.json`
(sibling to `/home/atogni/Desktop/progetti/atogni.github.io/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/atogni/Desktop/progetti/atogni.github.io/.claude/skills/gsd-*/`.
...
(`/home/atogni/Desktop/progetti/atogni.github.io/.claude`), NOT the skills sub-directory (`/home/atogni/Desktop/progetti/atogni.github.io/.claude/skills`).

This matches `installRuntimeArtifacts` and `uninstallRuntimeArtifacts`, which also
receive `/home/atogni/Desktop/progetti/atogni.github.io/.claude` as `configDir`. The skill dirs themselves live at
`/home/atogni/Desktop/progetti/atogni.github.io/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
'skills'` — they are derived from `configDir`, not the root for it.

```bash
# Claude Code — global install
RUNTIME_CONFIG_DIR="${CLAUDE_CONFIG_DIR:-/home/atogni/Desktop/progetti/atogni.github.io/.claude}"
SCOPE="global"
...
(i.e. `/home/atogni/Desktop/progetti/atogni.github.io/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/atogni/Desktop/progetti/atogni.github.io/.claude/.gsd-surface.json`
Install profile marker: `/home/atogni/Desktop/progetti/atogni.github.io/.claude/.gsd-profile`
Skill dirs: `/home/atogni/Desktop/progetti/atogni.github.io/.claude/skills/gsd-*/`
Engine module: `/home/atogni/Desktop/progetti/atogni.github.io/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/home/atogni/Desktop/progetti/atogni.github.io/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
